...
// 摄像头列表
const CameraList: FunctionComponent<FormComponentProps> = (props) => {
    ...
    const columns = [
        {title: '场地名称', dataIndex: '', width:300, sorter: true},
        {title: '场地编号', dataIndex: '',sorter: true},
        {title: '摄像头编号', dataIndex: '', sorter: true},
        {title: '摄像头IP', dataIndex: '',  sorter: true},
        {title: '绑定业务员', dataIndex: '',sorter: true},
        {title: '绑定车险支持坐席', dataIndex: '',sorter: true},
/*        {
            title: '状态',
            dataIndex: 'status',
            key: 'status1',
